...
const seedData = async () => {
  try {
    ...
    await Product.insertMany([
      ...
      { farmer: farmer1._id, farm: farmProfile1._id, title: 'Organic Bitter Gourd (Karela)', description: 'Fresh green bitter gourd, great for health & detox.', category: categories[0]._id, pricePerUnit: 32.00, unit: 'kg', stockQuantity: 65, harvestDate: new Date(), isOrganic: true, images: ['https://images.unsplash.com/photo-1592924357228-91a4daadcfea?auto=format&fit=crop&w=800&q=80'], status: 'available' },
      ...
      { farmer: farmer1._id, farm: farmProfile1._id, title: 'Fresh Farm Radish (Mooli)', description: 'Crisp white radishes with tender green leaves.', category: categories[0]._id, pricePerUnit: 15.00, unit: 'piece', stockQuantity: 100, harvestDate: new Date(), isOrganic: true, images: ['https://images.unsplash.com/photo-1592924357228-91a4daadcfea?auto=format&fit=crop&w=800&q=80'], status: 'available' },
      ...
      { farmer: farmer1._id, farm: farmProfile1._id, title: 'Farm Fresh Ginger (Adrak)', description: 'Aromatic spicy organic ginger roots.', category: categories[0]._id, pricePerUnit: 60.00, unit: 'kg', stockQuantity: 60, harvestDate: new Date(), isOrganic: true, images: ['https://images.unsplash.com/photo-1615485290382-441e4d049cb5?auto=format&fit=crop&w=800&q=80'], status: 'available' },
      ...
      { farmer: farmer1._id, farm: farmProfile1._id, title: 'Fresh Ruby Pomegranates (Anaar)', description: 'Juicy red pomegranates loaded with antioxidants.', category: categories[1]._id, pricePerUnit: 85.00, unit: 'kg', stockQuantity: 60, harvestDate: new Date(), isOrganic: true, images: ['https://images.unsplash.com/photo-1615485290382-441e4d049cb5?auto=format&fit=crop&w=800&q=80'], status: 'available' },
      ...
      { farmer: farmer1._id, farm: farmProfile1._id, title: 'Sweet Red Watermelon (Tarbooz)', description: 'Cool & refreshing red watermelon.', category: categories[1]._id, pricePerUnit: 25.00, unit: 'piece', stockQuantity: 40, harvestDate: new Date(), isOrganic: true, images: ['https://images.unsplash.com/photo-1587049352846-4a222e784d38?auto=format&fit=crop&w=800&q=80'], status: 'available' },
      ...
      { farmer: farmer1._id, farm: farmProfile1._id, title: 'Sweet Muskmelon (Kharbooja)', description: 'Aromatic sweet muskmelon.', category: categories[1]._id, pricePerUnit: 35.00, unit: 'kg', stockQuantity: 55, harvestDate: new Date(), isOrganic: true, images: ['https://images.unsplash.com/photo-1592924357228-91a4daadcfea?auto=format&fit=crop&w=800&q=80'], status: 'available' },
      ...
      { farmer: farmer1._id, farm: farmProfile1._id, title: 'Fresh Sweet Lime (Mosambi)', description: 'Juicy citrus sweet lime for fresh juice.', category: categories[1]._id, pricePerUnit: 45.00, unit: 'kg', stockQuantity: 75, harvestDate: new Date(), isOrganic: true, images: ['https://images.unsplash.com/photo-1611080626919-7cf5a9dbab5b?auto=format&fit=crop&w=800&q=80'], status: 'available' },
      ...
      { farmer: farmer1._id, farm: farmProfile1._id, title: 'Organic Rajma (Red Kidney Beans)', description: 'Premium Jammu organic red kidney beans.', category: categories[2]._id, pricePerUnit: 90.00, unit: 'kg', stockQuantity: 120, harvestDate: new Date(), isOrganic: true, images: ['https://images.unsplash.com/photo-1586201375761-83865001e31c?auto=format&fit=crop&w=800&q=80'], status: 'available' },
      { farmer: farmer1._id, farm: farmProfile1._id, title: 'Kabuli Chana (White Chickpeas)', description: 'Large white chickpeas, perfect for Chole.', category: categories[2]._id, pricePerUnit: 85.00, unit: 'kg', stockQuantity: 130, harvestDate: new Date(), isOrganic: true, images: ['https://images.unsplash.com/photo-1586201375761-83865001e31c?auto=format&fit=crop&w=800&q=80'], status: 'available' },

      // Dairy & Farm Eggs (6 items)
      { farmer: farmer1._id, farm: farmProfile1._id, title: 'Pure Dairy Cow Milk (Doodh)', description: 'Fresh, pure organic whole milk delivered daily in eco-friendly glass bottles.', category: categories[3]._id, pricePerUnit: 30.00, unit: 'litre', stockQuantity: 100, harvestDate: new Date(), isOrganic: true, images: ['https://images.unsplash.com/photo-1550583724-b2692b85b150?auto=format&fit=crop&w=800&q=80'], status: 'available' },
      { farmer: farmer1._id, farm: farmProfile1._id, title: 'Fresh Farm Paneer (Cottage Cheese)', description: 'Soft, artisanal fresh farm paneer.', category: categories[3]._id, pricePerUnit: 80.00, unit: 'box', stockQuantity: 50, harvestDate: new Date(), isOrganic: true, images: ['https://images.unsplash.com/photo-1528750997573-59b89d56f4f7?auto=format&fit=crop&w=800&q=80'], status: 'available' },
      ...
      { farmer: farmer1._id, farm: farmProfile1._id, title: 'Free-Range Country Hen Eggs (Ande)', description: 'Organic free-range brown eggs.', category: categories[3]._id, pricePerUnit: 60.00, unit: 'dozen', stockQuantity: 80, harvestDate: new Date(), isOrganic: true, images: ['https://images.unsplash.com/photo-1516467508483-a7212febe31a?auto=format&fit=crop&w=800&q=80'], status: 'available' },
